...
def ripemd160(data_in: bytes) -> bytes:
    try:
        ...
        raise ImportError("The 'pycryptodome' package is required for ripemd160 hashing on this system since hashlib does not support it. Please run 'pip install pycryptodome'")
